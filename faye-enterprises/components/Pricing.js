...
const PLANS = [
  {
    ...
    price: '$400',
    period: 'one time',
    sub: '3-week campaign — no commitment',
    highlight: false,
    badge: null,
    features: [
  ...
  },
  {
    ...
    price: '$1,500',
    period: '/ month',
    sub: 'Most popular plan for active brokers',
    highlight: true,
    badge: '⭐ Best Value',
    features: [
  ...
  },
  {
    ...
    price: '$2,000',
    period: '/ month',
    sub: 'For high-volume closers ready to scale',
    highlight: false,
    badge: null,
    features: [
      ...
      <div className="container">
        <div className={styles.header}>
          ...
          <p className="section-sub">
            No setup fees. No long-term contracts. Start with a 3-week pilot
            and scale when you see results.
          </p>
        </div>
        ...
        <div className={styles.roi}>
          ...
          <div>
            ...
            <div className={styles.roiText}>
              At just 3 closed policies per month — at $500 commission each — the Growth Plan pays for itself twice over.
              Most clients see positive ROI in their first 30 days.
            </div>
          </div>
        </div>
      </div>
